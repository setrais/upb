...
class Iblocks extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            [['uid'], 'required'],
            [['grid', 'pic_anons_id', 'pic_detile_id', 'act', 'del', 'createusers', 'updateusers', 'sort', 'is_main', 'is_pay', 'is_arhiv', 'is_use', 'types_iblocks_id', 'city_id', 'country_id', 'is_resize', 'pic_oreginal_id', 'pic_scr_id'], 'integer'],
            [['keywords', 'description', 'anons', 'detile'], 'string'],
            [['createdate', 'updatedate', 'datetime_start', 'datetime_end',], 'safe'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'datetime_start' => Yii::t('app/iblock', 'Start datetime'), // Start Datetime / Дата/время начала'),
            'datetime_end' => Yii::t('app/iblock', 'End datetime'), // Start Datetime / Дата/время окончания'),
            ...
            'country_id' => Yii::t('app/iblock', 'Is country'), // Is City / Страна к которой принадлежит'),
