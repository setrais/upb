...
class IblocksSearch extends Iblocks
{
    ...
    {
        return [
            [['id', 'grid', 'pic_anons_id', 'pic_detile_id', 'act', 'del', 'createusers', 'updateusers', 'sort', 'is_main', 'is_pay', 'is_arhiv', 'is_use', 'types_iblocks_id', 'city_id', 'country_id', 'is_resize', 'pic_oreginal_id', 'pic_scr_id'], 'integer'],
            [['uid', 'name', 'sid', 'title', 'keywords', 'description', 'anons', 'createdate', 'updatedate', 'datetime_start', 'datetime_end', 'detile', 'cid', 'maps_id', 'url', 'url_detile', 'url_list', 'visible', 'action', 'nid'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere([
            ...
            'DATE_FORMAT(datetime_start, \'%d-%m-%Y H:s:i\')' => $this->datetime_start,
            'DATE_FORMAT(datetime_end, \'%d-%m-%Y H:s:i\')' => $this->datetime_end,
            'sort' => $this->sort,
