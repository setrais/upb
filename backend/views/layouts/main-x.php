                ...
                <aside class="col-sm-9 col-lg-2 left">    <?php
                    ...
                    echo SideNav::widget([
                        ...
                        'items' => [
                            ...
                            ['label' => Yii::t('app/main','Управление контентом'), 'icon' => 'control', 'url' => Url::to(['/iblocks/control', 'type'=>$type]), 'active' => ( $controller == 'iblocks' || $item == 'control'),
                             'items'=>[['label' => /*/*'<span class="pull-right badge">10</span> '.*/Yii::t('app/menu','ИнфоБлоки'), 'url' => Url::to(['/iblocks/index', 'type'=>$type]), 'active' => ($item == 'index')],
                                          ['label' => /*'<span class="pull-right badge">5</span> '.*/Yii::t('app/menu','Верхнее меню'), 'url' => Url::to(['/iblocks/header-menus', /*'type'=>$type=1*/]), 'active' => ($item == 'header-menus')],
                                          ['label' => /*'<span class="pull-right badge">5</span> '.*/Yii::t('app/menu','Статьи'), 'url' => Url::to(['/iblocks/articles', /*'type'=>$type=2*/]), 'active' => ($item == 'articles')],
                                          ['label' => /*'<span class="pull-right badge">5</span> '.*/Yii::t('app/menu','Нижнее меню'), 'url' => Url::to(['/iblocks/footer-menus', /*'type'=>$type=3*/]), 'active' => ($item == 'footer-menus')],
                                          ['label' => /*'<span class="pull-right badge">5</span> '.*/Yii::t('app/menu','Страницы'), 'url' => Url::to(['/iblocks/pages', /*'type'=>$type=4*/]), 'active' => ($item == 'pages')],
                                          ['label' => /*'<span class="pull-right badge">5</span> '.*/Yii::t('app/menu','Новости'), 'url' => Url::to(['/iblocks/news', /*'type'=>$type=5*/]), 'active' => ($item == 'news')],
                                          ['label' => /*'<span class="pull-right badge">5</span> '.*/Yii::t('app/menu','Блоги'), 'url' => Url::to(['/iblocks/blogs', /*'type'=>$type=6*/]), 'active' => ($item == 'blogs')],
                                          ['label' => /*'<span class="pull-right badge">5</span> '.*/Yii::t('app/menu','Предложения'), 'url' => Url::to(['/iblocks/realestates', /*'type'=>$type=7*/]), 'active' => ($item == 'realestates')],
                                          ['label' => /*'<span class="pull-right badge">5</span> '.*/Yii::t('app/menu','Группы'), 'url' => Url::to(['/iblocks/groups', /*'type'=>$type=8*/]), 'active' => ($item == 'groups')],
                                          ['label' => /*'<span class="pull-right badge">5</span> '.*/Yii::t('app/menu','Разделы'), 'url' => Url::to(['/iblocks/sections', /*'type'=>$type=9*/]), 'active' => ($item == 'sections')],
                                          ['label' => /*'<span class="pull-right badge">5</span> '.*/Yii::t('app/menu','Меню'), 'url' => Url::to(['/iblocks/menus', /*'type'=>$type=10*/]), 'active' => ($item == 'menus')],
                                          ['label' => /*'<span class="pull-right badge">5</span> '.*/Yii::t('app/menu','Уделы'), 'url' => Url::to(['/iblocks/portions', /*'type'=>$type=11*/]), 'active' => ($item == 'portions')],
                                          ['label' => /*/*'<span class="pull-right badge">10</span> '.*/Yii::t('app/menu','Блоки'), 'url' => Url::to(['/iblocks/blocks', /*'type'=>$type=12*/]), 'active' => ($item == 'blocks')],
                                          ['label' => /*'<span class="pull-right badge">5</span> '.*/Yii::t('app/menu','Сообщения'), 'url' => Url::to(['/iblocks/messages', /*'type'=>$type=13*/]), 'active' => ($item == 'messages')],
                                          ['label' => /*'<span class="pull-right badge">5</span> '.*/Yii::t('app/menu','Расписания'), 'url' => Url::to(['/iblocks/schedules', /*'type'=>$type=14*/]), 'active' => ($item == 'schedules')],
                            ]],
                            ['label' => Yii::t('app/main','Справочники'), 'icon' => 'directory', 'url' => Url::to(['/site/directory', 'type'=>$type]), 'active' => ($item == 'directory'),
                                'items'=>[['label' => /*'<span class="pull-right badge">10</span> '.*/Yii::t('app/menu','Храмы'), 'url' => Url::to(['/site/hrams', 'type'=>$type]), 'active' => ($item == 'cities')],
                                          ...
                                          ['label' => /*'<span class="pull-right badge">5</span> '.*/Yii::t('app/menu','Расписание'), 'url' => Url::to(['/raspisanie/index', 'type'=>$type]), 'active' => ($controller == 'raspisanie' && $item == 'index')],
